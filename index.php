            ...
            <div class="text-center mb-12 px-4">
                ...
                <div class="bg-white/80 backdrop-blur-sm rounded-lg shadow-2xl p-4 sm:p-6 md:p-8 md:p-10 max-w-4xl mx-auto">
                    <form id="heroSearchForm" onsubmit="handleHeroSearch(event)" class="flex flex-row gap-2 sm:gap-3 md:gap-4">
                        ...
                        <button type="button" id="buyBtn" class="bg-dark-gold text-white px-4 py-3 sm:px-6 sm:py-4 rounded-lg font-medium hover:bg-gold transition flex items-center justify-center gap-1 sm:gap-2 whitespace-nowrap flex-shrink-0">
