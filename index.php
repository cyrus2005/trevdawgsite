...
<body class="bg-white text-black font-sans">
            ...
            <div class="max-w-6xl mx-auto">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-14 items-stretch">
                    ...
                    <div class="flex flex-col gap-4">
                        <button type="button" onclick="showUnderConstruction()" class="bg-white border-2 border-gray-200 rounded-lg p-5 sm:p-6 hover:border-dark-gold hover:shadow-xl transition-all group text-left relative overflow-hidden flex flex-row items-center gap-5 sm:gap-6 w-full">
    ...
    <div id="harBuyModal" class="hidden fixed inset-0 z-[100] flex items-center justify-center p-3 sm:p-6" role="dialog" aria-modal="true" aria-labelledby="harBuyModalTitle">
        <div id="harBuyModalBackdrop" class="absolute inset-0 bg-black/60 backdrop-blur-sm" tabindex="-1"></div>
        <div class="relative z-10 flex w-full max-w-6xl flex-col overflow-hidden rounded-xl bg-white shadow-2xl" style="height: min(90vh, 900px);">
            <div class="flex shrink-0 items-center justify-between gap-4 border-b border-gray-200 bg-white px-4 py-3">
                ...
                <button type="button" id="harBuyModalClose" class="p-1 text-3xl leading-none text-gray-500 hover:text-dark-gold" aria-label="Close">&times;</button>
            </div>
    ...
    <script>
        ...
        (function initHarBuyModalControls() {
            ...
            if (closeBtn) closeBtn.addEventListener('click', closeHarBuyModal);
