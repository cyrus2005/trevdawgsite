...
<body class="bg-white text-black font-sans">
    ...
    <!-- About Trevor Hondros - One Pager -->
    <section id="about" class="py-12 md:py-16 bg-white">
        <div class="container mx-auto px-4 md:px-6 max-w-6xl">
            
            <!-- Compact Header -->
            <div class="text-center mb-8 md:mb-12">
                <h2 class="text-3xl md:text-4xl font-bold text-gray-900 mb-3">About Trevor Hondros</h2>
                <p class="text-gray-600">Your trusted partner for Houston real estate</p>
            </div>

            <!-- One-Pager Layout: Desktop Horizontal, Mobile Stacked -->
            <div class="bg-gray-50 rounded-lg p-6 md:p-10">
                
                <!-- Top Section: Profile + Stats (Desktop: Side by Side) -->
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8 mb-8 md:mb-10 pb-8 md:pb-10 border-b border-gray-200">
                    <!-- Profile -->
                    <div class="flex flex-col md:flex-row items-center md:items-start gap-4">
                        <div class="flex-shrink-0 w-24 h-24 md:w-28 md:h-28 rounded-lg overflow-hidden bg-white shadow-sm">
                            <img src="assets/media/profile/trevor-hondros.jpg" alt="Trevor Hondros" class="w-full h-full object-cover" onerror="this.style.display='none'; this.parentElement.innerHTML='<div class=\'text-2xl font-serif font-bold text-dark-gold flex items-center justify-center h-full\'>TH</div>';">
                        </div>
                        <div class="flex-1 text-center md:text-left">
                            <h3 class="text-2xl md:text-3xl font-bold text-gray-900 mb-1">Trevor Hondros</h3>
                            <p class="text-gray-600 text-sm md:text-base">Real Estate Professional</p>
                            <p class="text-xs md:text-sm text-gray-500">Priority One Real Estate</p>
                        </div>
                    </div>

                    <!-- Stats -->
                    <div class="md:col-span-2 grid grid-cols-3 gap-4 md:gap-6">
                        <div class="text-center">
                            <div class="text-3xl md:text-4xl font-bold text-dark-gold mb-1" id="aboutYearsExp" data-target="3" data-suffix="+">0+</div>
                            <div class="text-xs font-medium text-gray-600">Years</div>
                        </div>
                        <div class="text-center border-l border-r border-gray-300">
                            <div class="text-3xl md:text-4xl font-bold text-dark-gold mb-1" id="aboutSalesVolume" data-target="5" data-suffix="M" data-prefix="$">$0M</div>
                            <div class="text-xs font-medium text-gray-600">Sales Volume</div>
                        </div>
                        <div class="text-center">
                            <div class="text-3xl md:text-4xl font-bold text-dark-gold mb-1" id="aboutClients" data-target="18" data-suffix="+">0+</div>
                            <div class="text-xs font-medium text-gray-600">Clients</div>
                        </div>
                    </div>
                </div>

                <!-- Middle Section: Features (Desktop: 3 columns, Mobile: Stacked) -->
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6 mb-8 md:mb-10 pb-8 md:pb-10 border-b border-gray-200">
                    <div class="flex items-start gap-3">
                        <div class="flex-shrink-0 w-10 h-10 bg-dark-gold rounded-lg flex items-center justify-center">
                            <svg class="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4"></path>
                            </svg>
                        </div>
                        <div>
                            <h4 class="font-bold text-gray-900 mb-1">Competitive Rates</h4>
                            <p class="text-sm text-gray-600">Expert negotiation for the best deals</p>
                        </div>
                    </div>
                    <div class="flex items-start gap-3">
                        <div class="flex-shrink-0 w-10 h-10 bg-dark-gold rounded-lg flex items-center justify-center">
                        ...
                        <div>
                            <h4 class="font-bold text-gray-900 mb-1">Full Support</h4>
                            <p class="text-sm text-gray-600">Guidance from search to closing</p>
                        </div>
                    </div>
                    <div class="flex items-start gap-3">
                        <div class="flex-shrink-0 w-10 h-10 bg-dark-gold rounded-lg flex items-center justify-center">
                        ...
                        <div>
                            <h4 class="font-bold text-gray-900 mb-1">Local Expertise</h4>
                            <p class="text-sm text-gray-600">Deep knowledge of Houston market</p>
                        </div>
                    </div>
                </div>

                <!-- Bottom Section: Brief Bio (Desktop: 2 columns, Mobile: Stacked) -->
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
                    <div>
                        <h3 class="text-xl md:text-2xl font-bold text-gray-900 mb-3">Why Choose Trevor?</h3>
                        <p class="text-gray-700 text-sm md:text-base leading-relaxed">
                            With <strong>$5 million in sales volume</strong> and <strong>18+ satisfied clients</strong>, Trevor combines local market expertise with a service-first approach to help buyers, sellers, and investors achieve their real estate goals.
                        </p>
                    </div>
                    <div>
                        <h3 class="text-xl md:text-2xl font-bold text-gray-900 mb-3">My Story</h3>
                        <p class="text-gray-700 text-sm md:text-base leading-relaxed">
            ...
            <div class="mt-8 md:mt-10 text-center">
                <div class="flex flex-col sm:flex-row gap-3 justify-center items-center">
                    <a href="tel:7134080604" class="bg-dark-gold text-white px-6 md:px-8 py-3 rounded-lg font-semibold hover:bg-gold transition inline-flex items-center gap-2">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"></path>
                        </svg>
                        Call (713) 408-0604
                    </a>
                    <a href="#contact" class="border-2 border-dark-gold text-dark-gold px-6 md:px-8 py-3 rounded-lg font-semibold hover:bg-dark-gold hover:text-white transition inline-flex items-center gap-2">
                        Get Started
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
