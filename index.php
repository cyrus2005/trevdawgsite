                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-14 items-stretch">
                    ...
                    <div class="flex flex-col justify-center bg-gray-50 border-2 border-gray-200 rounded-xl p-6 sm:p-8 lg:min-h-full">
                        ...
                        <div class="flex flex-col gap-3">
                            <a href="https://www.har.com/idx/mls/listing?sitetype=aws&amp;cid=770582&amp;mlsorgid=1&amp;allmls=n" target="_blank" rel="noopener noreferrer" class="flex items-center justify-between gap-4 bg-white border-2 border-gray-200 rounded-lg px-4 py-4 hover:border-dark-gold hover:shadow-md transition-all group w-full text-left cursor-pointer no-underline">
                                <div class="text-left">
                                ...
                                <svg class="w-5 h-5 text-dark-gold flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path></svg>
                            </a>
